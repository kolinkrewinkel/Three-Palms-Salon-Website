...
{    
	$('#jq-class').columnHover({eachCell:true, hoverClass:'betterhover', includeSpans:true, ignoreCols: [2]});
});

function loadPage(){var showItem=function(){var self=this;$(self).stop().animate({'opacity':1},1500,'easeOutExpo')};var timeout=0;$('.init').each(function(n){var self=this;$(self).css({'opacity':0});setTimeout(function(){showItem.apply(self)},timeout+=150)})};
...
$(function () {$('.table-fade').click(function () {dismiss();});
});
$(function () {
